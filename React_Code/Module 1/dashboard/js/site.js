(function() {
  ...
  var Pragmatometer = React.createClass({displayName: "Pragmatometer",
    render: function() {
      return ( React.createElement("div", {className: "Pragmatometer"}, 
          React.createElement(Calendar, null), 
          React.createElement(Todo, null), 
          React.createElement(Scratch, null), 
          React.createElement(YouPick, null)
        )
      );
    }
  });
  var Scratch = React.createClass({displayName: "Scratch",
    render: function() {
      var saved_state = restore('Scratchpad', '');
      return ( React.createElement("div", {id: "Scratchpad"}, 
  ...
  var Todo = React.createClass({displayName: "Todo",
    ...
    render: function() {
      ...
      var display_item_details = function(label, item) {
        ...
        return ( React.createElement("td", {className: label, title: label}, 
            React.createElement("input", {onChange: that.handle_change, id: html_id, 
      ...
      var display_item = function(item) {
        ...
        return ( React.createElement("tr", null, rendered_nodes, 
      ...
      return ( React.createElement("div", {id: "Todo"}, 
          ...
          React.createElement("table", null, 
              ...
              React.createElement("tfoot", null, 
                React.createElement("textarea", {onChange: this.onChange, 
                 value: this.state.text}), React.createElement("br", null), 
  ...
  var YouPick = React.createClass({displayName: "YouPick",
    ...
    render: function() {
      ...
      return ( React.createElement("div", {id: "YouPick"}, 
